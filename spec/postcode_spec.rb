require 'spec_helper'
require_relative '../lib/generator/random_postcode'
...
describe Postcodesio do
  ...
  context 'requesting information on a single postcode works correctly' do
    ...
    before(:all) do
      ...
      @random_postcode = Postcodesio.new.get_random_postcode
      p @random_postcode.get_random_postcode
      @single_service.get_single_postcode(@random_postcode.get_random_postcode)
    end
    ...
    it "should return an ordnance survey eastings value as integer" do
      expect(@single_service.get_ordnance_eastings).to be_kind_of(Integer)
    end

    it "should return an ordnance survey northings value as integer" do
      expect(@single_service.get_ordnance_northings).to be_kind_of(Integer)
    end

    it "should return a country which is one of the four constituent countries of the UK" do
      expect(@single_service.get_country).to match("England").or match("Scotland")
    end
